 ...
 * parsing errors will go unreported and bizarre behaviour may result.
 *
 * <p>For XML processing errors, a SAX driver must use this interface instead of throwing an
 ...
 * continue to provide useful information after a call to {@link #fatalError fatalError} (in other
 * words, a SAX driver class could catch an exception and report a fatalError).
 *
 * @since SAX 1.0
