...
public interface AttributeList {
   ...
   * Attributes without values (those declared #IMPLIED without a value specified in the start tag)
   ...
   *
   * <p>If the parser has not read a declaration for the attribute, or if the parser does not report
   * attribute types, then it must return the value "CDATA" as stated in the XML 1.0 Recommentation
   ...
   * be concatenated into a single string separated by whitespace.
   *
   * @param i The index of the attribute in the list (starting at 0).
