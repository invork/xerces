 ...
 * currently in force for each context and automatically processes qualified XML 1.0 names into
 * their Namespace parts; it can also be used in reverse for generating XML 1.0 from Namespaces.
 *
...
public class NamespaceSupport {
   ...
   * enumeration; check for the default prefix using the {@link #getURI getURI} with an argument of
   * "".
   *
   ...
   * @param isAttribute true if this prefix is for an attribute (and the default Namespace is not
   *     allowed).
